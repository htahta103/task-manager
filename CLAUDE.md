...
**YOU ARE IN: `taskmanager/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/taskmanager/` (rig root) or other directories
...
**Your mail address:** `taskmanager/polecats/rust`
**Your rig:** taskmanager
**Your Witness:** `taskmanager/witness`
...
| Ask Witness for help | `gt mail send taskmanager/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`taskmanager/witness`) when:
...
```bash
gt mail send taskmanager/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
